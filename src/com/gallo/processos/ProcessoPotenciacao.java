...
import com.gallo.calculos.Potenciacao;
import com.gallo.io.Entrada;

public class ProcessoPotenciacao extends Processo {
	@Override
	public void processar() {
		System.out.println("Digite o primeiro numero para potenciação:");
		leitor = new Entrada();
		double numero1 = leitor.receberNumeroDouble();
		System.out.println("Digite o segundo numero para potenciação:");
		leitor = new Entrada();
